...
<div class='cancel'><h1>Cancel Booking</h1></div>
        <div id="op">
            <table  > 
                <tr>
                    ...
                    <td class='active'><a href="cancelbookings.php">Cancel Booking</a></td>
...
?></p>
    ...
    <table  class='bt1' id='userTable' cellspacing=2 cellpadding=10>
        ...
        $row=mysqli_fetch_array($r);
           ...
           $r1=mysqli_query($con,"select * from bookings where bookercontact='$row[0]' and status='1' and cancel='no'");
            while($row1=mysqli_fetch_array($r1))
            {
                ...
                <td><a href="cancelbookings1.php?bookid=<?php echo $row1[0]; ?>">cancel</a></td>
                    </tr>
<?php }?></tbody>
             </table>
             </div>
